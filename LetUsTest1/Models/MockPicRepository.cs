    ...
    public class MockPicRepository : IPicsRepository
    {
        ...
        private void InitializePics()
        {
            _pics = new List<Pics>
            {
                ...
                new Pics {Id = 6, Name = "Bagram Air Base", Description = "Standing with soldiers and my luggage", LongDescription = "I have been trying to figure out why it is night time and I am standing with my luggage in Bagram.   I remember arriving in daylight hours and then leaving in daylight hours.   So why am I standing there with all my luggage at night?   I dunno.   The funny thing is I remember the picture being taken, but I still cannot remember why I was out there with my luggage.", ImageUrl = "\\pics\\12-16-09_Bagram 016.jpg"},
                new Pics {Id = 7, Name = "Leaving US for Qater", Description = "I was embarking on a crazy journey", LongDescription = "Well this was an anxious time.   I knew I was leaving that night to Qater.   This picture was taken in South Carolina.   I was flying to Dulles airport in Virginia where I boarded a flight to Doha, Qatar.   It was the beginning of a trip that was way outside my comfort zone.   Of course I will say the obvious.   That would be that... 'I wish I doid not know now what I did not know then'  ...lol", ImageUrl = "\\pics\\1stnight qatar 001.jpg"  },
                ...
                new Pics {Id = 14, Name = "Barbecue at KAF", Description = "A Nice Day for a Barbeque at KAF", LongDescription = "Well I knew I was getting cole to the end.   Becuase of me success?????, I was asked/made to stay longer.   I for whatever stupid reason. to grow a beard...of sorts.  Well then I got really itchy in the face a bit just after this picture was taken.   Beard got shaved off before it amounted to much.   I like a bare face! ", ImageUrl = "\\pics\\Kandahar Near End 001.jpg"},
